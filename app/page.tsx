...
const slides = [
  ...
  {
    id: 2,
    image: '/hero-bg.png', // Idéalement une autre image ici
    subtitle: 'Nouveautés',
    title: "Grace & Mercy",
    description: "Des designs minimalistes pour porter vos convictions avec fierté.",
...
const featuredProducts = [
  ...
  {
    id: 3,
    name: 'T-Shirt Olive Branch',
    price: 45.00,
    image: '/products/tshirt-beige.png',
